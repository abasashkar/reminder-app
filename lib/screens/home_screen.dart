...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void setReminder(String day, String time, String activity) {
    ...
    selectedTime =
        DateFormat.jm().format(DateTime.now().toLocal()); // Reset selectedTime
  }
  ...
  void checkReminders() async {
    ...
    for (int i = 0; i < reminderList.length; i++) {
      ...
      if (currentTime == reminderTime &&
          ...
          reminderList[i].isReminded == false) {
        setState(() {
          reminderList[i].isReminded = true;
        });
        AudioServices.playAudio('alert_audio.mp3');
        showCustomSnackBar(
            context, 'Reminder: It\'s time to ${reminderList[i].activity}');
        break;
      }
    }
  }
                            ...
                            return Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    mainAxisAlignment: reminderList[
                                                reminderList.length - index - 1]
                                            .isReminded
                                        ? MainAxisAlignment.spaceBetween
